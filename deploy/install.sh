...
SUPPORT_BUNDLE="$SCRIPT_DIRECTORY/support_bundle.py"
SUPPORT_BUNDLE_CLI="$SCRIPT_DIRECTORY/support_bundle_cli.py"
...
file_mode() {
  case "$1" in
    ...
    config/sources.json)
      printf '0644\n'
      ;;
    lib/support_bundle.py | lib/updater_protocol.py | lib/updater_trace.py)
      printf '0644\n'
      ;;
    *)
      printf '0600\n'
