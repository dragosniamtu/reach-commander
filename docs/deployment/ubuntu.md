...
- a discovery channel: `stable`, `edge`, or an exact `vX.Y.Z`;
...
- [Traefik](traefik.dynamic.yaml) — an HTTPS router, external password file, and an explicit 50 GiB buffering limit.
