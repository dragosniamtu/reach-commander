...
for data_file in LICENSE VERSION compose.release.yaml compose.updater.yaml lan_address.py render_config.py updater_protocol.py lib/common.sh systemd/reachcommander-updater.service; do
